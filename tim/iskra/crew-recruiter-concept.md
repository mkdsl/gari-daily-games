...
Mini deck-builder / crew manager (nije rađeno u GDG katalogu)
...
- **guncati (tie-in):** ending screen CTA "Pravi tim se gradi na Guncatiju [DATUM]." + link ka volonterskom pozivu Guncati Grand Finale. W34 timing (17–23.08) = Tom Sawyer poziv period
...
- **Mile Mehanika:** synergy matrica (7 uloga × 5 event slotova = 35 ćelija) + Vibe Score formula balance pass
