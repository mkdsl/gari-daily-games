...
- [x] P3 `src/content/aforizmi.js` — dodati event-tied Pera Period linije za svaku Kluboslavija stanicu turneje (Avala, Štrand, Sarajevo, Guncati) u radio overlay pool (done 2026-09-10, commit TBD)
