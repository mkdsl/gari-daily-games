...
- [x] P3 `src/ui/end-screen.js` — dodati "bio sam tamo" path via localStorage bridge sa Guncati Grand/Pasošem za povratnike, pretvara igru u keepsake ne samo teaser (done 2026-09-10, commit TBD)
