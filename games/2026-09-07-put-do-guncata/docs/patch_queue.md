...
- [x] P2 `src/systems/branching.js` + `src/state.js` — `resetBranching()` se poziva samo u `startBtn` click-u, dodati i u `initState()` da bude idempotentan (done 2026-09-10, commit TBD)
