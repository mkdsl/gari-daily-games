...
- [x] P2 `src/ui/end-screen.js` — epilog nema personalizovan trag koji igrač prepoznaje kao "moj run": ubaciti jedan konkretan detalj puta (ime rute + aforizam koji je čuo na radiju etape 1–2) u zaključnu karticu da dolazak oseća earned, ne generički (done 2026-09-10, commit TBD)
