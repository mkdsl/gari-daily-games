...
| 3 | **Repetitivnost** — 10 nivoa sa istom baznom akcijom (klikni bar) može postati monotono od nivoa 6 nadalje. Specijalne mehanike (treper, multi-bag) moraju biti vizuelno jasno diferencirane, inače se stopi u blur. | MEDIUM |
