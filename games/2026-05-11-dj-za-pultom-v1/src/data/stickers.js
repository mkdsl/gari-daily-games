...
export const STICKERS = [
  ...
  { id: 'music',      cat: 'vector', label: 'Muzika',    short: 'V2', icon: 'disc',      color: '#ffb24a' },
  { id: 'knowledge',  cat: 'vector', label: 'Znanje',    short: 'V3', icon: 'book',      color: '#7ac0ff' },
  { id: 'mixing',     cat: 'vector', label: 'Miks',      short: 'V4', icon: 'sliders',   color: '#9af28a' },
  ...
  { id: 'reckless',   cat: 'vector', label: 'Reckless',  short: 'V9', icon: 'star',      color: '#ff4040',
    locked: true, unlock_hint: 'Znanje tier 2+' },

  // Recovery (S2) — 3 tipa × 2 use = 6 total per sezona
  { id: 'recovery_tisina',       cat: 'recovery', label: 'Tišina',         short: 'R1', icon: 'silence', color: '#88a8b8', uses_left_field: 'tisina' },
  ...
  { id: 'zovi_covika', cat: 'substance', label: 'Zovi čoveka', short: 'Z', icon: 'phone', color: '#c84a4a' }
];
...
export const DAYS_OF_WEEK = ['Pon', 'Uto', 'Sre', 'Čet', 'Pet', 'Sub', 'Ned'];

// Slot delovi dana
export const SLOT_LABELS = ['Jutro', 'Popodne', 'Veče'];
