...
- [x] P3 `src/config.js` + `src/systems/phases.js` — Phase A pacing: PHASE_A_TOTAL_REVENUE 25k→12k din; first-session player dostiže Fazu A za ~15 min (done 2026-08-03, commit PENDING)
