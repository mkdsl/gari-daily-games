...
- [x] P3 `src/content/brand_hooks.js` + `src/systems/masterclass.js` — dodaj 3 Guncati brand hook-a: trigger na masterclassCount 3/5/8, evergreen in-game notifikacije ka guncati.rs (done 2026-08-05, commit 58a206a)
