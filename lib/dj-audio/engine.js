  ...
  async resume() {
    if (this.ctx.state === 'suspended') {
      try {
        ...
        // iOS<14: resume() može da baci ako nije iz user gesture-a
        // ili ako kontekst nije u suspended state-u koji ovaj browser podržava
        console.warn('[dj-audio] AudioContext.resume() failed:', e.message);
      }
    }
